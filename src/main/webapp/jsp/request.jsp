...
<%
	// jsp에 내장되어있는 기본 객체가 존재한다 ( request, response )
%>
<body>
<h2>jsp에 내장되어있는 기본 객체가 존재한다 ( request, response )</h2>
	...
	<h3> ★ request.getContextPath() context path = <%= request.getContextPath() %> </h3>
